    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="min-h-screen -mt-20 -sm:mt-10 pt-10 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-9xl mx-auto px-6 sm:px-12 lg:px-10 h-[calc(100vh-5rem)] flex items-center justify-start">
          ...
          >
            {/* Brand Badge */}
            <div className='px-5 sm:px-20 mb-30 sm:mb-0'>
            ...
            <div className="flex flex-wrap gap-4 px-10 sm:px-20 ">
              <Link
                to="/shop"
                className="group -mb-10 mt-30 bg-emerald-500 text-white font-bold py-4 px-10 rounded-full hover:bg-emerald-400 transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-0.5 inline-flex items-center gap-2"
              >
                Shop Now
