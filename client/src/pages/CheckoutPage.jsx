                ...
                <div className="flex flex-col items-center">
                  <div
                    className={`flex items-center justify-center w-12 h-12 rounded-full font-bold ${
                      isActive ? 'bg-emerald-100 text-emerald-600 ring-4 ring-emerald-100' : 'bg-stone-200 text-stone-400'
                    }`}
                  >
                    <IconComponent size={20} />
                  </div>
                  <span
                    className={`text-sm mt-2 font-semibold ${isActive ? 'text-emerald-700' : 'text-stone-400'}`}
                  >
                    {step.label}
                  </span>
                </div>
